...
namespace CivicdAPI.Migrations
{
  ...
  internal sealed class Configuration : DbMigrationsConfiguration<CivicdAPI.Models.ApplicationDbContext>
  {
    ...
    protected override void Seed(CivicdAPI.Models.ApplicationDbContext context)
    {
      ...
      var activity1 = context.Activities.FirstOrDefault(x => x.DisplayTitle == "City Council Meeting");
      var activity2 = context.Activities.FirstOrDefault(x => x.DisplayTitle == "Phone Bank");
      var activity3 = context.Activities.FirstOrDefault(x => x.DisplayTitle == "School Meeting");
      var tag1 = context.Tags.FirstOrDefault(x => x.Name == "Liberal");
      var tag2 = context.Tags.FirstOrDefault(x => x.Name == "Activism");
      var tag3 = context.Tags.FirstOrDefault(x => x.Name == "Inequality");
      var tag4 = context.Tags.FirstOrDefault(x => x.Name == "Privacy");
